...
screen about():
    ...
    ## включён в порт просмотра внутри экroomрана игрового меню.
    use game_menu(_("Об игре"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Ace Attorney: 9A - Chronicles – это игра-пародия в жанре «визуальная новелла», сделанная на основе игры от capcom «Phoenix Wright - Ace Attorney» (на Японском - «Gyakuten Saiban»). Игра является предысторией к сюжету сериала «Ace Attorney: 9A». События переносят нас в 6-7 класс (2018-2019 год), где в школе №1945 началась практика «судебных заседаний» по различным делам. Игроку предстоит управлять одним из учеников «А» класса, который будет адвокатом и защищать своего одноклассника в суде. В игре представлены 5 уникальных дел из прошлого, которые расскажут предысторию персонажей и вселенной AA:9A.")

            text _("\nИдея, сюжет, текстуры - Лев Телятников")
            text _("Программист, издатель - Максим Батарон")
            text _("Композитор - Леонид Скуратов")
            text _("\nРелиз: Лето 2022")
