...
define config.name = _("AA:9A - Chronicles")
...
define config.version = "0.1-prealpha (Made by VenTeam, coded by Maxim Bataron)"
...
define config.main_menu_music = cornered_theme
...
define config.save_directory = "AA9AChronicles-1653245729"
